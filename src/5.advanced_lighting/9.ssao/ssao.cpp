...
int main()
{
    ...
    // -------------------------
    Shader shaderGeometryPass("9.ssao_geometry.vs.glsl", "9.ssao_geometry.fs.glsl");
    Shader shaderLightingPass("9.ssao.vs.glsl", "9.ssao_lighting.fs.glsl");
    Shader shaderSSAO("9.ssao.vs.glsl", "9.ssao.fs.glsl");
    Shader shaderSSAOBlur("9.ssao.vs.glsl", "9.ssao_blur.fs.glsl");
    ...
    // 我们可以对场景中每一个片段创建一个随机旋转向量，但这会很快将内存耗尽。所以，更好的方法是创建一个小的随机旋转向量纹理平铺在屏幕上
