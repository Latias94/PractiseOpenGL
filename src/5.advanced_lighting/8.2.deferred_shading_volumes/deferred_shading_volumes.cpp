...
int main()
{
    ...
    // -------------------------
    Shader shaderGeometryPass("8.2.g_buffer.vs.glsl", "8.2.g_buffer.fs.glsl");
    Shader shaderLightingPass("8.2.deferred_shading.vs.glsl", "8.2.deferred_shading.fs.glsl");
    Shader shaderLightBox("8.2.deferred_light_box.vs.glsl", "8.2.deferred_light_box.fs.glsl");
