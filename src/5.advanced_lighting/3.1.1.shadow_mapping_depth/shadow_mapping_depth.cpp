...
int main()
{
    ...
    // -------------------------
    Shader simpleDepthShader("3.1.1.shadow_mapping_depth.vs.glsl", "3.1.1.shadow_mapping_depth.fs.glsl");
    Shader debugDepthQuad("3.1.1.debug_quad.vs.glsl", "3.1.1.debug_quad_depth.fs.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 我们从光的位置的视野下使用了不同的投影和视图矩阵来渲染的场景
