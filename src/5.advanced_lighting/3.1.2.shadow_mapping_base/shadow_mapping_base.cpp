...
int main()
{
    ...
    // -------------------------
    Shader shader("3.1.2.shadow_mapping.vs.glsl", "3.1.2.shadow_mapping.fs.glsl");
    Shader simpleDepthShader("3.1.2.shadow_mapping_depth.vs.glsl", "3.1.2.shadow_mapping_depth.fs.glsl");
    Shader debugDepthQuad("3.1.2.debug_quad.vs.glsl", "3.1.2.debug_quad_depth.fs.glsl");
