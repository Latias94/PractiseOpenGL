...
int main()
{
    ...
    // -------------------------
    Shader shader("3.1.3.shadow_mapping.vs.glsl", "3.1.3.shadow_mapping.fs.glsl");
    Shader simpleDepthShader("3.1.3.shadow_mapping_depth.vs.glsl", "3.1.3.shadow_mapping_depth.fs.glsl");
    Shader debugDepthQuad("3.1.3.debug_quad.vs.glsl", "3.1.3.debug_quad_depth.fs.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 然而，我们只关心深度值，并非所有片元计算都在我们的着色器中进行。为了提升性能，我们将使用一个与之不同但更为简单的着色器来渲染出深度贴图
