...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("5.1.light_casters.vs.glsl", "5.1.light_casters.fs.glsl");
    Shader lampShader("5.1.lamp.vs.glsl", "5.1.lamp.fs.glsl");
...
//    glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 绘制物体
        lightingShader.use();
        // 定义光源的方向（注意我们将方向定义为从光源出发的方向，你可以很容易看到光的方向朝下）
