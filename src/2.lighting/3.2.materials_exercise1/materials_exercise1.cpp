...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("3.2.materials.vs.glsl", "3.2.materials.fs.glsl");
    Shader lampShader("3.2.lamp.vs.glsl", "3.2.lamp.fs.glsl");
...
//    glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // 注意材质表格中的环境光值可能与漫反射值不一样，它们没有考虑光照的强度。要想纠正这一问题
        // 你需要将所有的光照强度都设置为vec3(1.0)，这样才能得到正确的输出
