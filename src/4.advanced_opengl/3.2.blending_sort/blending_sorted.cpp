...
//    glBlendFuncSeparate(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA, GL_ONE, GL_ZERO);
    ...
    // -------------------------
    Shader shader("3.2.blending.vs.glsl", "3.2.blending.fs.glsl");
    ...
    // transparent window locations 窗户的位置
    // --------------------------------
...
//        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);
        ...
        // （因为我们将它的环绕方式设置为了GL_REPEAT。这通常是没问题的，
        // 但是由于我们使用了透明值，纹理图像的顶部将会与底部边缘的纯色值进行插值。
