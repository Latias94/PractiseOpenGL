...
//    glStencilFunc(GL_EQUAL, 1, 0xFF);
    ...
    // -------------------------
    Shader shader("2.stencil_testing.vs.glsl", "2.stencil_testing.fs.glsl");
    Shader shaderSingleColor("2.stencil_testing.vs.glsl", "2.stencil_single_color.fs.glsl");
